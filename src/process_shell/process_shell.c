...
void	execute_shell_command(t_cmd_invoke *parsed_list, char *command, int *last_status, char ***env)
{
...
void	handle_input(char *input, History *history, int *last_status, char ***env)
{
